...
!function(require, exports, module) {
    ...
    /*v:24*/
    template("account/signup/signup", '<div class="layout-err-tips hide" data-error="true"></div> <div class="layout-cont">  <div class="layer-login"> <div class="hd-login"> <a class="icon-camera" href="#nolink"></a> <img class="avatar hide" src="/image/test_pro2.jpg" alt=""> </div> <div class="box-inpt"> <span class="icon-account"></span> <input class="login-inpt" type="text" data-model="postedData.username" placeholder="请输入昵称"> </div> <div class="box-inpt"> <span class="icon-email"></span> <input class="login-inpt" type="text" data-model="postedData.useremail" placeholder="请输入邮箱"> </div> <div class="box-inpt"> <span class="icon-keyword"></span> <input class="login-inpt" type="password" data-model="postedData.userpassword" placeholder="请输入密码"> <a data-touchstart-event="seepassword" data-touchend-event="seepassword" data-class="seepassclass">  </a> </div> <div class="box-inpt"> <span>验</span> <input class="login-inpt" type="tel" data-model="postedData.vercode" placeholder="请输入验证码"> <san class="ver"> <img src="/cgi-bin/account/verifycode" alt=""> </san> </div> <div class="button"> <a data-click-event="signup" class="btn-buy">完成注册</a> </div> </div>  </div>'), 
    /*v:5*/
