...
define(function(require, exports,module) {
    ...
    dialog.alert = function(text,option){
    	option = option || {};
    	option.zIndex = option.zIndex || 10;
	...
	dialog.wxshare = function(){
		var helper = $('<div class="popup-wxshare"><span class="share-wx">点击右上角，分享到朋友圈</span></div>');
		this.showMask();
	...
	dialog.wxopeninbrowser = function(){
		var helper = $('<div class="popup-wxshare"><span class="pay-wx">点击右上角，用浏览器打开再支付</span></div>');
		this.showMask();
		helper.appendTo('body');
	...
	dialog.showDataLoader = function(){
		$('#data-loader').show();
	};
	dialog.hideDataLoader = function(){
		$('#data-loader').hide();
	};
